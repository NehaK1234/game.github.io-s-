var grown, enemyImage, baImage, scene, ball, alien1, alien2, alien3, score=0, opscore=0, speed=5

function preload(){
  
  grown = loadImage("b.png");
  enemyImage = loadImage("alien.png");
  baImage = loadImage("ball.png");
...
function setup() {
  ...
  scene.addImage(grown)
  ball = createSprite(200,345,200,345)
  ball.addImage(baImage)
  ball.scale=0.1
